...
const Translation = () => {
  ...
  const [readFull, setReadFull ] = useState(1);
  ...
  useEffect(() => {
    fetch(`https://api.quran.com/api/v4/verses/by_chapter/${surahNumber}?language=bn&words=true&word_translation_language=bn&fields=text_uthmani&translation_fields=resource_name,language_id&mushaf=2&word_fields=text_uthmani&audio=true&per_page=${readFull > 10?readFull:10}&page=${page}`)
      .then((res) => res.json())
      .then((data) => {
...
// handle previous, next, read full and countinue surah
const handlePrev = ()=>{
   if(surahNumber > 1){
  ...
  return (
    <div className="reading-quran mt-5">
      <div className="container">
        <div className="row">
          <div className="col-lg-12 px-0">
            <div className="surah-container">
              <div className="surah-header px-3 mb-3 border-bottom pb-1">
                <div className="row justify-content-between align-items-center">
                  ...
                  <div className="col-sm-4">
                    ...
                    <h6  className="text-center fs-3"> بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيم </h6>
                    </div>
                  </div>
                  <div className="col-sm-4">
                    <h6
                    ...
                    return (
                      ...
                      >
                        {wordsArr.map((ayah) => (
                         ...
                         <p className="bangla-translation">
                         {wordsArr.map((ayah) => (
                          <span
                            onClick={() => handleAudio(ayah.audio_url)}
                            className="word"
              ...
              {words.length ? (
                <div className="control-pagination text-center my-5">
               {surahNumber>1?<button onClick={handlePrev} className="btn btn-sm btn-outline-success btn-light">
                ...
                {pagination.total_records > 10?   <button onClick={handleReadFull} className="btn btn-sm btn-outline-success btn-light ms-3">
                 ...
                 Countinue &nbsp; <FontAwesomeIcon icon={faAngleRight} />
                  ...
                  <button onClick={handleNext} className="btn btn-sm btn-outline-success btn-light ms-3">
        ...
        <p className="text-start">showing page {page} of {pagination?.total_pages} pages </p>
